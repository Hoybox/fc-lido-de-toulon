...
import TestLogo from './components/TestLogo'; // ✅ Import du test logo
...
const ErrorBanner: React.FC = () => {
  ...
  return (
    <div
      className="fixed top-24 left-1/2 -translate-x-1/2 w-11/12 max-w-3xl 
      bg-red-800/95 backdrop-blur-sm border-2 border-red-500 text-white 
      p-4 rounded-lg shadow-2xl z-[100] animate-fade-in"
      role="alert"
    >
      <div className="flex items-start">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-red-400 mr-4 shrink-0"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <div className="flex-grow">
          ...
          <p className="text-sm mt-1">
            Impossible de contacter le serveur backend. Il est probablement éteint.
          </p>
          ...
          <ol className="list-decimal list-inside text-sm mt-1 space-y-1">
            ...
            <li>
              Exécutez :{' '}
              <code className="bg-black/50 px-2 py-1 rounded-md text-yellow-300 font-mono">
                npm start
              </code>
            </li>
          </ol>
  ...
  const renderPage = () => {
    switch (activePage) {
      ...
      case Page.Club:
        return <ClubPage />;
      case Page.Panini:
        if (user.role !== Role.Admin) return <HomePage setActivePage={setActivePage} />;
        return <PaniniPage />;
      case Page.Penalty:
        return <PenaltyPage />;
      default:
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <main className="pt-32 pb-16 md:pb-0">
        ...
        {/* ✅ Test logo intégré en bas de page */}
